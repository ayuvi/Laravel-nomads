                ...
                <div class="col-lg-8 pl-lg-0">
                    <div class="card card-details">
                        ...
                        <div class="features row">
                            <div class="col-md-4">
                                <img src="{{ url('frontend/images/Group 25.png') }}" alt="" class="features-image" />
                            ...
                            <div class="col-md-4 border-left">
                                <div class="description">
                                    <img src="{{ url('frontend/images/Component 6 – 2.png') }}" alt="" class="features-image" />
                                    <div class="description">
                                        <h3>Language</h3>
                                        <p>{{$item->language}}</p>
                                    </div>
                            ...
                            <div class="col-md-4 border-left">
                                <div class="description">
                                    <img src="{{ url('frontend/images/Component 8 – 2.png') }}" alt="" class="features-image" />
                                    <div class="description">
                                        <h3>Foods</h3>
                                        <p>{{$item->foods}}</p>
                                    </div>
